...
then
    ...
    then
        ...
        info "› git pull /zsh-syntax-highlighting"
        cd "$ZSH/custom/plugins/zsh-syntax-highlighting" && gp
    fi
    ...
    then
        ...
        info "› git pull /zsh-autosuggestions"
        cd "$ZSH/custom/plugins/zsh-autosuggestions" && gp
    fi
    ...
    then
        ...
        info "› git pull /spaceship-prompt"
        cd "$ZSH/custom/themes/spaceship-prompt" && gp
    fi
fi
